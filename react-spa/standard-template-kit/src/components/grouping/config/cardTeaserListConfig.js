...
function CardTeaserListConfig ({ 
  ...
  return (
    <div className='cardTeaserListWrapper configComponents'>
      ...
      <div className='cardTeaserListComponent' style={listComponentStyles}>
        ...
        <ul className={`cardTeaserList`}style={listStyles}>
          {column1 && <EditableArea className={`listComponents cardTeasersArea layout${layout}`} content={column1}/>}
        </ul>
      </div>
    </div>
  );
...
export default CardTeaserListConfig;
